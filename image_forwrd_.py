...
def main():
    ...
    parser.add_argument('--output_folder', default='dataset/crop_256/predict', type=str)
    # model
    ...
    dataloader = utils.get_loader(args.data_name, img_size=args.img_size,
                                  ...
                                  split=args.split,dataset='CDDataset')
    model = CDEvaluator(args=args, dataloader=dataloader)
    #checkpoint_name=args.checkpoint_name
    model._load_checkpoint(checkpoint_name=args.checkpoint_name)
